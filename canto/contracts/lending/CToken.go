...
func (_Ctoken *CtokenCaller) NOERROR(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Ctoken.contract.Call(opts, &out, "NO_ERROR")
...
//
// Solidity: function NO_ERROR() view returns(uint256)
func (_Ctoken *CtokenSession) NOERROR() (*big.Int, error) {
	return _Ctoken.Contract.NOERROR(&_Ctoken.CallOpts)
}

// NOERROR is a free data retrieval call binding the contract method 0x69ab3250.
//
// Solidity: function NO_ERROR() view returns(uint256)
func (_Ctoken *CtokenCallerSession) NOERROR() (*big.Int, error) {
	return _Ctoken.Contract.NOERROR(&_Ctoken.CallOpts)
}
...
func (_Ctoken *CtokenTransactor) Initialize(opts *bind.TransactOpts, comptroller_ common.Address, interestRateModel_ common.Address, initialExchangeRateMantissa_ *big.Int, name_ string, symbol_ string, decimals_ uint8) (*types.Transaction, error) {
	return _Ctoken.contract.Transact(opts, "initialize", comptroller_, interestRateModel_, initialExchangeRateMantissa_, name_, symbol_, decimals_)
}

// Initialize is a paid mutator transaction binding the contract method 0x99d8c1b4.
//
// Solidity: function initialize(address comptroller_, address interestRateModel_, uint256 initialExchangeRateMantissa_, string name_, string symbol_, uint8 decimals_) returns()
func (_Ctoken *CtokenSession) Initialize(comptroller_ common.Address, interestRateModel_ common.Address, initialExchangeRateMantissa_ *big.Int, name_ string, symbol_ string, decimals_ uint8) (*types.Transaction, error) {
	return _Ctoken.Contract.Initialize(&_Ctoken.TransactOpts, comptroller_, interestRateModel_, initialExchangeRateMantissa_, name_, symbol_, decimals_)
}

// Initialize is a paid mutator transaction binding the contract method 0x99d8c1b4.
//
// Solidity: function initialize(address comptroller_, address interestRateModel_, uint256 initialExchangeRateMantissa_, string name_, string symbol_, uint8 decimals_) returns()
func (_Ctoken *CtokenTransactorSession) Initialize(comptroller_ common.Address, interestRateModel_ common.Address, initialExchangeRateMantissa_ *big.Int, name_ string, symbol_ string, decimals_ uint8) (*types.Transaction, error) {
	return _Ctoken.Contract.Initialize(&_Ctoken.TransactOpts, comptroller_, interestRateModel_, initialExchangeRateMantissa_, name_, symbol_, decimals_)
}
